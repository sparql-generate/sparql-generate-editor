module.exports = {table:
{
  ...
  "*[[subGenerateQuery,.],?constructTriples]" : {
     ...
     "}": []}, 
  "*[[subPerformQuery,.],*performCall]" : {
     "PERFORM": ["[[subPerformQuery,.],*performCall]","*[[subPerformQuery,.],*performCall]"], 
     "}": []}, 
  ...
  "*graphNodePath" : {
     ...
     "TEMPLATE": ["graphNodePath","*graphNodePath"], 
  ...
  "*orderCondition" : {
     ...
     "}": []}, 
  "*performCall" : {
     "VAR1": ["performCall","*performCall"], 
     "VAR2": ["performCall","*performCall"], 
     "IRI_REF": ["performCall","*performCall"], 
     "IRI_REF_START": ["performCall","*performCall"], 
     "START_XEXPR": ["performCall","*performCall"], 
     "PNAME_LN": ["performCall","*performCall"], 
     "PNAME_NS": ["performCall","*performCall"], 
     "}": [], 
     "PERFORM": []}, 
  "*tExpression" : {
  ...
  "[>=,numericExpression]" : {
     ">=": [">=","numericExpression"]}, 
  "[?argList,generateClause]" : {
     "{": ["?argList","generateClause"], 
     "NIL": ["?argList","generateClause"], 
     "(": ["?argList","generateClause"]}, 
  "[?argList,performClause]" : {
     "{": ["?argList","performClause"], 
     "NIL": ["?argList","performClause"], 
     "(": ["?argList","performClause"]}, 
  "[?argList,templateClause]" : {
     "{": ["?argList","templateClause"], 
     "NIL": ["?argList","templateClause"], 
     "(": ["?argList","templateClause"]}, 
  "[ACCEPT,varOrXIri]" : {
     "ACCEPT": ["ACCEPT","varOrXIri"]}, 
  "[AS,var]" : {
  ...
  "[[subPerformQuery,.],*performCall]" : {
     "PERFORM": ["[subPerformQuery,.]","*performCall"]}, 
  "[^^,iriRef]" : {
     "^^": ["^^","iriRef"]}, 
  "[^^,xiri]" : {
     "^^": ["^^","xiri"]}, 
  ...
  "constructTriples" : {
     ...
     "TEMPLATE": ["triplesSameSubject","?[.,?constructTriples]"], 
  ...
  "expressionList" : {
     ...
     "(": ["(","expression","*[,,expression]",")"]}, 
  "extQuery" : {
     "GENERATE": ["prologue","or([generateQuery,templateQuery,performQuery])","valuesClause"], 
     "TEMPLATE": ["prologue","or([generateQuery,templateQuery,performQuery])","valuesClause"], 
     "PERFORM": ["prologue","or([generateQuery,templateQuery,performQuery])","valuesClause"], 
     "BASE": ["prologue","or([generateQuery,templateQuery,performQuery])","valuesClause"], 
     "PREFIX": ["prologue","or([generateQuery,templateQuery,performQuery])","valuesClause"]}, 
  "filter" : {
  ...
  "generateClauseSub" : {
     ...
     "TEMPLATE": ["?constructTriples","*[[subGenerateQuery,.],?constructTriples]"], 
     ...
     "}": ["?constructTriples","*[[subGenerateQuery,.],?constructTriples]"]}, 
  "generateQuery" : {
     "GENERATE": ["GENERATE","?[sourceSelector,?varList]","generateClause","*datasetClause","*bindingClauses","?whereClause","solutionModifier"]}, 
  "graphGraphPattern" : {
  ...
  "groupGraphPatternSub" : {
     ...
     "TEMPLATE": ["?triplesBlock","*[graphPatternNotTriples,?.,?triplesBlock]"], 
  ...
  "objectListPath" : {
     ...
     "TEMPLATE": ["objectPath","*[,,objectPath]"], 
  ...
  "or([[integer,or([[,,or([},[integer,}]])],}])],[,,integer,}]])" : {
     "INTEGER": ["[integer,or([[,,or([},[integer,}]])],}])]"], 
     ",": ["[,,integer,}]"]}, 
  "or([[varOrXIri,?argList],[?argList,generateClause]])" : {
     "VAR1": ["[varOrXIri,?argList]"], 
     "VAR2": ["[varOrXIri,?argList]"], 
     "IRI_REF": ["[varOrXIri,?argList]"], 
     "IRI_REF_START": ["[varOrXIri,?argList]"], 
     ...
     "NIL": ["[?argList,generateClause]"], 
     "(": ["[?argList,generateClause]"]}, 
  "or([[varOrXIri,?argList],[?argList,performClause]])" : {
     "VAR1": ["[varOrXIri,?argList]"], 
     "VAR2": ["[varOrXIri,?argList]"], 
     "IRI_REF": ["[varOrXIri,?argList]"], 
     "IRI_REF_START": ["[varOrXIri,?argList]"], 
     ...
     "NIL": ["[?argList,performClause]"], 
     "(": ["[?argList,performClause]"]}, 
  "or([[varOrXIri,?argList],[?argList,templateClause]])" : {
     "VAR1": ["[varOrXIri,?argList]"], 
     "VAR2": ["[varOrXIri,?argList]"], 
     "IRI_REF": ["[varOrXIri,?argList]"], 
     "IRI_REF_START": ["[varOrXIri,?argList]"], 
  ...
  "or([expression,[{,constructTriples,}]])" : {
     ...
     "STRING_LITERAL_LONG2_START": ["expression"], 
     "{": ["[{,constructTriples,}]"]}, 
  "or([generateQuery,templateQuery,performQuery])" : {
  ...
  "pExpression" : {
     ...
     "+": ["or([expression,[{,constructTriples,}]])"], 
     "-": ["or([expression,[{,constructTriples,}]])"], 
     "VAR1": ["or([expression,[{,constructTriples,}]])"], 
     "VAR2": ["or([expression,[{,constructTriples,}]])"], 
     "(": ["or([expression,[{,constructTriples,}]])"], 
     "STR": ["or([expression,[{,constructTriples,}]])"], 
     "LANG": ["or([expression,[{,constructTriples,}]])"], 
     "LANGMATCHES": ["or([expression,[{,constructTriples,}]])"], 
     "DATATYPE": ["or([expression,[{,constructTriples,}]])"], 
     "BOUND": ["or([expression,[{,constructTriples,}]])"], 
     "IRI": ["or([expression,[{,constructTriples,}]])"], 
     "URI": ["or([expression,[{,constructTriples,}]])"], 
     "BNODE": ["or([expression,[{,constructTriples,}]])"], 
     "RAND": ["or([expression,[{,constructTriples,}]])"], 
     "ABS": ["or([expression,[{,constructTriples,}]])"], 
     "CEIL": ["or([expression,[{,constructTriples,}]])"], 
     "FLOOR": ["or([expression,[{,constructTriples,}]])"], 
     "ROUND": ["or([expression,[{,constructTriples,}]])"], 
     "CONCAT": ["or([expression,[{,constructTriples,}]])"], 
     "STRLEN": ["or([expression,[{,constructTriples,}]])"], 
     "UCASE": ["or([expression,[{,constructTriples,}]])"], 
     "LCASE": ["or([expression,[{,constructTriples,}]])"], 
     "ENCODE_FOR_URI": ["or([expression,[{,constructTriples,}]])"], 
     "CONTAINS": ["or([expression,[{,constructTriples,}]])"], 
     "STRSTARTS": ["or([expression,[{,constructTriples,}]])"], 
     "STRENDS": ["or([expression,[{,constructTriples,}]])"], 
     "STRBEFORE": ["or([expression,[{,constructTriples,}]])"], 
     "STRAFTER": ["or([expression,[{,constructTriples,}]])"], 
     "YEAR": ["or([expression,[{,constructTriples,}]])"], 
     "MONTH": ["or([expression,[{,constructTriples,}]])"], 
     "DAY": ["or([expression,[{,constructTriples,}]])"], 
     "HOURS": ["or([expression,[{,constructTriples,}]])"], 
     "MINUTES": ["or([expression,[{,constructTriples,}]])"], 
     "SECONDS": ["or([expression,[{,constructTriples,}]])"], 
     "TIMEZONE": ["or([expression,[{,constructTriples,}]])"], 
     "TZ": ["or([expression,[{,constructTriples,}]])"], 
     "NOW": ["or([expression,[{,constructTriples,}]])"], 
     "UUID": ["or([expression,[{,constructTriples,}]])"], 
     "STRUUID": ["or([expression,[{,constructTriples,}]])"], 
     "MD5": ["or([expression,[{,constructTriples,}]])"], 
     "SHA1": ["or([expression,[{,constructTriples,}]])"], 
     "SHA256": ["or([expression,[{,constructTriples,}]])"], 
     "SHA384": ["or([expression,[{,constructTriples,}]])"], 
     "SHA512": ["or([expression,[{,constructTriples,}]])"], 
     "COALESCE": ["or([expression,[{,constructTriples,}]])"], 
     "IF": ["or([expression,[{,constructTriples,}]])"], 
     "STRLANG": ["or([expression,[{,constructTriples,}]])"], 
     "STRDT": ["or([expression,[{,constructTriples,}]])"], 
     "SAMETERM": ["or([expression,[{,constructTriples,}]])"], 
     "ISIRI": ["or([expression,[{,constructTriples,}]])"], 
     "ISURI": ["or([expression,[{,constructTriples,}]])"], 
     "ISBLANK": ["or([expression,[{,constructTriples,}]])"], 
     "ISLITERAL": ["or([expression,[{,constructTriples,}]])"], 
     "ISNUMERIC": ["or([expression,[{,constructTriples,}]])"], 
     "TRUE": ["or([expression,[{,constructTriples,}]])"], 
     "FALSE": ["or([expression,[{,constructTriples,}]])"], 
     "COUNT": ["or([expression,[{,constructTriples,}]])"], 
     "SUM": ["or([expression,[{,constructTriples,}]])"], 
     "MIN": ["or([expression,[{,constructTriples,}]])"], 
     "MAX": ["or([expression,[{,constructTriples,}]])"], 
     "AVG": ["or([expression,[{,constructTriples,}]])"], 
     "SAMPLE": ["or([expression,[{,constructTriples,}]])"], 
     "GROUP_CONCAT": ["or([expression,[{,constructTriples,}]])"], 
     "SUBSTR": ["or([expression,[{,constructTriples,}]])"], 
     "REPLACE": ["or([expression,[{,constructTriples,}]])"], 
     "REGEX": ["or([expression,[{,constructTriples,}]])"], 
     "EXISTS": ["or([expression,[{,constructTriples,}]])"], 
     "NOT": ["or([expression,[{,constructTriples,}]])"], 
     "IRI_REF": ["or([expression,[{,constructTriples,}]])"], 
     "IRI_REF_START": ["or([expression,[{,constructTriples,}]])"], 
     "INTEGER": ["or([expression,[{,constructTriples,}]])"], 
     "DECIMAL": ["or([expression,[{,constructTriples,}]])"], 
     "DOUBLE": ["or([expression,[{,constructTriples,}]])"], 
     "INTEGER_POSITIVE": ["or([expression,[{,constructTriples,}]])"], 
     "DECIMAL_POSITIVE": ["or([expression,[{,constructTriples,}]])"], 
     "DOUBLE_POSITIVE": ["or([expression,[{,constructTriples,}]])"], 
     "INTEGER_NEGATIVE": ["or([expression,[{,constructTriples,}]])"], 
     "DECIMAL_NEGATIVE": ["or([expression,[{,constructTriples,}]])"], 
     "DOUBLE_NEGATIVE": ["or([expression,[{,constructTriples,}]])"], 
     "PNAME_LN": ["or([expression,[{,constructTriples,}]])"], 
     "PNAME_NS": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL1": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL1_START": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL2": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL2_START": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL_LONG1": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL_LONG1_START": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL_LONG2": ["or([expression,[{,constructTriples,}]])"], 
     "STRING_LITERAL_LONG2_START": ["or([expression,[{,constructTriples,}]])"]}, 
  "path" : {
     "^": ["pathAlternative"], 
     "a": ["pathAlternative"], 
     "!": ["pathAlternative"], 
  ...
  "performClause" : {
     "{": ["{","performClauseSub","}"]}, 
  "performClauseSub" : {
     "PERFORM": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "VAR1": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "VAR2": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "IRI_REF": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "IRI_REF_START": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "START_XEXPR": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "PNAME_LN": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "PNAME_NS": ["*performCall","*[[subPerformQuery,.],*performCall]"], 
     "}": ["*performCall","*[[subPerformQuery,.],*performCall]"]}, 
  "performQuery" : {
     "PERFORM": ["PERFORM","?[sourceSelector,?varList]","performClause","*datasetClause","*bindingClauses","?whereClause","solutionModifier"]}, 
  "prefixDecl" : {
  ...
  "propertyListNotEmpty" : {
     ...
     "TEMPLATE": ["verb","objectList","*[;,?[verb,objectList]]"], 
  ...
  "string" : {
     ...
     "STRING_LITERAL_LONG2": ["STRING_LITERAL_LONG2"]}, 
  "subGenerateQuery" : {
     "GENERATE": ["GENERATE","or([[varOrXIri,?argList],[?argList,generateClause]])","*datasetClause","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"]}, 
  "subPerformQuery" : {
     "PERFORM": ["PERFORM","or([[varOrXIri,?argList],[?argList,performClause]])","*datasetClause","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"]}, 
  "subSelect" : {
     "SELECT": ["selectClause","whereClause","solutionModifier","valuesClause"]}, 
  "subTemplateQuery" : {
     "TEMPLATE": ["TEMPLATE","or([[varOrXIri,?argList],[?argList,templateClause]])","*datasetClause","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"]}, 
  "substringExpression" : {
  ...
  "triplesBlock" : {
     ...
     "TEMPLATE": ["triplesSameSubjectPath","?[.,?triplesBlock]"], 
  ...
  "triplesSameSubject" : {
     ...
     "TEMPLATE": ["varOrXTerm","propertyListNotEmpty"], 
  ...
  "triplesSameSubjectPath" : {
     ...
     "TEMPLATE": ["varOrXTerm","propertyListPathNotEmpty"], 
  ...
  "verb" : {
     ...
     "TEMPLATE": ["storeProperty","varOrXTerm"], 
