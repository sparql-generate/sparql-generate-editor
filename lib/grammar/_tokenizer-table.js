module.exports = {table:
{
  ...
  "string" : {
     ...
     "STRING_LITERAL_LONG2": ["STRING_LITERAL_LONG2"]}, 
  "subGenerateQuery" : {
     "GENERATE": ["GENERATE","or([[varOrXIri,?argList],[?varList,generateClause]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"]}, 
  "subPerformQuery" : {
     "PERFORM": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "VAR1": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "VAR2": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "IRI_REF": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "IRI_REF_START": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "START_XEXPR": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "PNAME_LN": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"], 
     "PNAME_NS": ["or([performCall,[PERFORM,or([performCall,[?varList,performClause]])]])","*bindingClauses","?[WHERE,groupGraphPattern]","solutionModifier"]}, 
  "subSelect" : {
